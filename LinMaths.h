...
double lm_dst(Vector p1, Vector p2);										// Calculates the distance between two points in R3
Vector lm_parametric(Vector p0, Vector p1, double t);					// Calculates the XYZ value using the line parametric from p1 to p2
